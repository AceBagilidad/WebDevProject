...
<?php
include('./action/popularProducts.php');
// Loop through the results and display each product dynamically
if ($result->num_rows > 0) {
while ($product = $result->fetch_assoc()) {
    $avg_rating = round($product['avg_rating']);  // Round the average rating to the nearest integer
    echo '
